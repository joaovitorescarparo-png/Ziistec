...
revoke all on function public.zt_finalize_pending_work_order_pricing(uuid,integer) from public,anon;
grant execute on function public.zt_finalize_pending_work_order_pricing(uuid,integer) to authenticated,service_role;
